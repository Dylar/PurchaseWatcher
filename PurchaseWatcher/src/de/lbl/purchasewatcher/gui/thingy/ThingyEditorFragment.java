...
public class ThingyEditorFragment extends MainViewFragment
{
	...
	{
		ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(App.ctx, android.R.layout.simple_spinner_item, list);
